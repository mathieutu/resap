  ...
  const options: Options = {
    renderNode: {
      [BLOCKS.EMBEDDED_ASSET]: (node) => {
        ...
        return `
          <a href=${attr(file.url)} target="_blank" rel="noopener noreferer" class="not-prose inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded text-blue-default bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-default">
