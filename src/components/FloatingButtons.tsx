...
const ShareButton = () => (
  <Menu as="div" className="relative inline-block text-left">
    ...
    >
      <Menu.Items className="z-10 absolute left-0 mt-2 w-56 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-hidden">
        <div className="py-1">
          <Menu.Item>
            {({ active }) => (
              <LinkedinShareButton
