...
type ButtonProps = ButtonHTMLAttributes<any> & { type: 'submit' | 'reset' | 'button' } & ClassNameProps

export const PrimaryButton = (props: ButtonProps) => (
  <button {...props} className={className(primaryClassName, props.className)} />
)
...
export const SecondaryButton = (props: ButtonProps) => (
  <button {...props} className={className(secondaryClassName, props.className)} />
)
