              ...
              <form onSubmit={handleSubmit} className="lg:flex-1 flex items-center justify-center px-2  lg:justify-end">
                ...
                <div className="relative">
                  ...
                  <input
                    id="search"
                    name="search"
                    className="w-full block pl-10 py-2 border border-gray-default rounded-md leading-5 bg-white placeholder-gray-default focus:outline-none focus:placeholder-gray-default focus:ring-1 focus:ring-blue-default focus:border-blue-default sm:text-sm"
